...
const commands = [
  ...
  [nodeExecutable, ['--experimental-vm-modules', './node_modules/jest/bin/jest.js', '--runInBand', 'apps/server/src/server.test.ts', 'apps/server/src/conversion-transport-regression.test.ts', 'packages/database/src/index.test.ts', 'packages/drawing-model/src/index.test.ts', 'packages/cad-import/src/index.test.ts', 'packages/renderer-webgl/src/index.test.ts']]
]
